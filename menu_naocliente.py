def menu_nao cliente()
squidBank = int(input("  Seja Bem vindo(a) ao Squid Bank, você selecionou a opção: NÃO SOU CLIENTE! "
                      "\n  Para informação sobre Empréstimos: Digite 1. "
                      "\n  Para informação sobre Cartões: Digite 2. "
                      "\n  Para informação sobre Consórcio: Digite 3. "
                      "\n  Para informação sobre Solução De Dívidas: Digite 4. "
...
if (squidBank == 1):
    ...
    if (squidBank == 2):
        escolha = int(input(" Digite 1 para saber sobre o nosso cartão ouro; "
                            "\n Digite 2 para saber sobre o nosso cartão ourocard Pré-pago;  "
                            "\n Digite 3 para saber sobre o nosso cartão Gold; "
                            "\n Digite 4 para saber sobre o nosso cartão Platinum; "
                            "\n Digite 5 para saber sobre o nosso cartão Black; "
                            "\n Escolha qual das opções que você deseja informação: "))

        if escolha == 1:
            ouro = ("""
            CARACTERÍSTICAS - O seu cartão internacional cheio de vantagens.
        ...
        if escolha == 2:
            ourocad_Pré_pago = ("""
            CARACTERÍSTICAS - Ideal para mesadas ou compras do dia a dia. 
        ...
        if escolha == 3:
            gold = ("""
            CARACTERÍSTICAS - Conte com um cartão com benefícios no Brasil e no exterior, 
        ...
        if escolha == 4:
            platinum = ("""
            CARACTERÍSTICAS - Pontuação diferenciada e benefícios exclusivos em viagens.
            RENDA MENSAL - Análise de crédito no Banco.
        ...
        if escolha == 5:
            black = ("""
            CARACTERÍSTICAS - Pontuação especial, benefícios e vantagens exclusivas 
    ...
    squidBank != (1, 2, 3, 4)
    return (f"Você selecionou um opção que não existe, volte ao {retornar_menu_principal}")