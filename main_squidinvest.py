...
apelido=(input("Como você quer ser chamade?"))
print(f"######################## SquidInvest+ ########################")
print(f"Bem-vinde ao nosso canal de investimentos, {apelido}!")
...
if escolha1 == 1:
    ...
    if escolha == 1:
        ...
        from projetom1.funcoes_si import prefix
        prefix(c,t,a)
    ...
    # Tesouro SELIC #
        ...
        a=float(input("Digite o valor que você depositaria por mês: "))
        t=float(input("Por quanto tempo você deixaria seu dinheiro investido (ano)?  "))
        from projetom1.funcoes_si import selic
        selic(c,t,a)
    ...
    # Tesouro IPCA+ #
        ...
        a=float(input("Digite o valor que você depositaria por mês: "))
        t=float(input("Por quanto tempo você deixaria seu dinheiro investido (ano)?  "))
        from projetom1.funcoes_si import ipcam
        ipcam(c,t,a)
